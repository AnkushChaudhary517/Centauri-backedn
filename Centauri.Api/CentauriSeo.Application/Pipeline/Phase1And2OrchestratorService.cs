...
public class Phase1And2OrchestratorService
{
    ...
    public async Task<OrchestratorResponse> RunAsync(SeoRequest request, AiIndexinglevelLocalLlmResponse fullLocalLlmTags)
    {
       ...
       //geminiTags.RemoveAll(x => x == null ||x.Sentence == null);
        ...
        var elableHandleMismatch = false;
        if (elableHandleMismatch && anyMismatch != null && anyMismatch.Count>0)
        {
        ...
        Level2Scores level2Scores = null, OrchestratorResponse orchestratorResponse = null)
    {
        ...
        try
        {
            ...
            //{
            //    entities = JsonSerializer.Deserialize<List<string>>(cachedEntities, options);
            //}
            ...
            var request = JsonSerializer.Serialize(new
            {
                ...
                Scores = level2Scores,
                //Entities= entities,
                SearchIntent = Enum.GetName(orchestratorResponse.SectionScoreResponse.Intent),
